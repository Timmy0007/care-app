...
const insurance = () => {
  return (
    <div className='insurance'>
        ...
        <div className='worry'>Worry Less!!! <br/><b className='health'>Health Insurance</b> Plans Cover You</div>
        <div className='worry2'>Careapp Has A Health Insurance Feature, Which Requires You To Must Have Been On A Registered Health Insurance Plan And Wouldn't Require You To Pay For Consultancy Fee With The Doctor. <br/><p className='health2'>The Health Insurance Company Will Be Responsible For Costs Covered By The Health Insurance Policy.</p></div>
